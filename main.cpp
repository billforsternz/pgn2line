...
int main( int argc, const char *argv[] )
{
    ...
    {
        printf(
            "wordsearch V3.00 (from Github.com/billforsternz/pgn2line)\n"
    ...
    {
        printf(
            "tournaments V3.00 (from Github.com/billforsternz/pgn2line)\n"
    ...
    {
        printf(
            "players V3.00 (from Github.com/billforsternz/pgn2line)\n"
    ...
    {
        printf(
            "line2pgn V3.00 (from Github.com/billforsternz/pgn2line)\n"
