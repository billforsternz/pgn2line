...
// Basic form: fin, fout
static int func_remove_auto_commentary( std::ifstream &in, std::ofstream &out );
static int func_justify( std::ifstream &in, std::ofstream &out );
static int func_nzcf_game_id( std::ifstream &in, std::ofstream &out );
static int func_refine_dups( std::ifstream &in, std::ofstream &out );
static int func_remove_exact_pairs( std::ifstream &in, std::ofstream &out );
...
static int func_hardwired( std::ifstream &in, std::ofstream &out );
static int func_time( std::ifstream &in, std::ofstream &out );
static int func_golden( std::ifstream &in, std::ofstream &out );

// Aux input file: fin_aux, fin, fout
static int func_pluck( std::ifstream &in_aux, std::ifstream &in, std::ofstream &out, bool reorder );
static int func_bulk_out_skeleton( std::ifstream &in_aux, std::ifstream &in, std::ofstream &out );
static int func_improve( std::ifstream &in_aux, std::ifstream &in, std::ofstream &out );
static int func_add_ratings( std::ifstream &in_aux, std::ifstream &in, std::ofstream &out );
static int func_collect_fide_id( std::ifstream &in_aux, std::ifstream &in, std::ofstream &out );
static int func_put_name_fide_id( std::ifstream &in_aux, std::ifstream &in, std::ofstream &out );

// Misc:
static int func_event( std::ifstream &in, std::ofstream &out, std::string &replace_event );
static int func_teams( std::ifstream &in, std::ofstream &out, std::string &name_tsv, std::string &teams_csv );
...
static COMMAND table[] =
{
    ...
    {collect_fide_id,    4,  "z nz-fide-ids.txt in.lpgn out.lpgn     ;Collect games with NZ players"},
...
int main( int argc, const char **argv )
{
    ...
    switch( purpose )
    {
        ...
        case put_name_fide_id:
        {
            ...
            switch( purpose )
            {
                ...
                case pluck_games_reorder:
                {
                    return func_pluck( in_aux, in, out, purpose==pluck_games_reorder );
                    break;
                }
                case bulk_out_skeleton:
                {
                    return func_bulk_out_skeleton( in_aux, in,  out );
                    break;
                }
                case improve:
                {
                    return func_improve( in_aux, in,  out );
                    break;
                }
                case add_ratings:
                {
                    return func_add_ratings( in_aux, in,  out );
                    break;
                }
                case collect_fide_id:
                {
                    return func_collect_fide_id( in_aux, in,  out );
                    break;
                }
                case put_name_fide_id:
                {
                    return func_put_name_fide_id( in_aux, in,  out );
                    break;
                }
            }
        }
    ...
    switch( purpose )
    {
        ...
        case refine_dups:
        {
            return func_refine_dups( in, out );
            break;
        }
        case remove_exact_pairs:
        {
            return func_remove_exact_pairs( in, out );
            break;
        }
        ...
        case hardwired:
        {
            return func_hardwired( in, out );
            break;
        }
        case times:
        {
            return func_time( in, out );
            break;
        }
        case golden:
        {
            return func_golden( in, out );
            break;
        }
        case event:
        {
            std::string replacement_name( argv[4] );
            return func_event( in, out, replacement_name );
            break;
        }
        case teams:
        {
            ...
            return func_teams( in, out, name_tsv, teams_csv );
            break;
        }
    }
    return 0;
